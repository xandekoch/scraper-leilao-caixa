...
const COLUMNS: ReadonlyArray<keyof ImovelListItem> = [
  ...
  "detalheComarca",
  "detalheOficio",
  "detalheInscricaoImobiliaria",
  "detalheAverbacaoLeiloesNegativos",
  "detalheAreaTotalM2",
  "detalheAreaPrivativaM2",
  "detalheEndereco",
  "detalheDescricao",
  "detalheFormasPagamentoRaw",
  "detalheAceitaRecursosProprios",
  "detalheAceitaFGTS",
  "detalheAceitaFinanciamento",
  "modalidade",
  "tipoImovel",
  "areaUtilM2",
  "quartos",
